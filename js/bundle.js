...
(function() {
  function displaySearchResults(results, store) {
    ...
    if (results.length) { // Are there any results?
      ...
      for (var i = 0; i < results.length; i++) {  // Iterate over the re sults
...
},{"lunr":5,"lunr-languages/lunr.ja":1,"lunr-languages/lunr.multi":2,"lunr-languages/lunr.stemmer.support":3,"lunr-languages/tinyseg":4}]},{},[6]);
